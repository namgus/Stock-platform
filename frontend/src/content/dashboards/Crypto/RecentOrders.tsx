...
function RecentOrders() {
  ...
  useEffect(() => {
    ...
    const apiCalls = Object.keys(dictionary).map((key) => {
      ...
      return axios.all([
        axios.get(`http://43.201.185.173:8000/stock/financial?code=${companyCode}`),
        axios.get(`http://43.201.185.173:8000/stock/price?code=${companyCode}`),
        axios.get(`http://43.201.185.173:8000/stock/predict?code=${companyCode}`)
      ]);
    });
