...
import { CryptoOrder, CryptoOrderStatus } from 'src/models/financial_all';
  ...
  const ListItemAvatarWrapper = styled(ListItemAvatar)(
    ...
    background: ${
      theme.palette.mode === 'dark'
        ...
        : alpha(theme.colors.alpha.black[100], 0.03)
    };
              ...
              return (
                ...
                >
                  <TableCell align='center'>
                    {/* <Link color="primary" variant="soft"> */}
